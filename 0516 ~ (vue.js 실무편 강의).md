...
<img src="./imgs/end17_2.png"  width="700"/>
...
<img src="./imgs/end18.png"  width="700"/>
...
<img src="./imgs/end20.png" width="700"/>
...
<img src="./imgs/end25.png" width="700"/>
...
<img src="./imgs/end29.png" width="700"/>


<h3> 30강 (라우팅 동작 확인) </h3>

<img src="./imgs/end30.png" width="700"/>
...
<img src="./imgs/end31.png" width="700"/>
...
<img src="./imgs/end32.png" width="700"/>
...
<img src="./imgs/end33_1.png" width="700"/>
<img src="./imgs/end33_2.png" width="700"/>
<img src="./imgs/end33_3.png" width="700"/>
...
<img src="./imgs/end36.png" width="700"/>
...
<img src="./imgs/end38.png" width="700"/>
...
<img src="./imgs/end39_1.png" width="700"/>
...
<img src="./imgs/end39_2.png" width="700"/>
...
<img src="./imgs/end39_3.png" width="700"/>
...
<img src="./imgs/end40.png" width="700"/>

- api end point : node.js를 실행한 서버의 주소???

<br/>
<img src="./imgs/end40_2.png" width="700"/>
...
<img src="./imgs/end41_1.png" width="700"/>

	- console의 Network의 XHR은 네트워크 요쳥에 대해서만 필터링을 해서 볼 수 있는 것이다.
<br/><br/>

<img src="./imgs/end41_2.png" width="700"/>
...
<img src="./imgs/end41_3.png" width="700"/>
...
<img src="./imgs/end42_1.png" width="700"/>

	===> .then( ).catch( )를 사용해서 작성해줘도 된다.
		(이게 기존에 내가 배웠고 사용했던 방법)
<br/><br/>

<img src="./imgs/end42_2.png" width="700"/>
...
<img src="./imgs/end42_3.png" width="700"/>
...
<img src="./imgs/end43_1.png" width="700"/>

	==> 공통된 url을 보다 효율적으로 사용할 수 있도록 공통화를 해줄 필요가 있다.

<br/><br/>

<img src="./imgs/end43_2.png" width="700"/>
...
<img src="./imgs/end43_3.png" width="700"/>
...
<img src="./imgs/end43_4.png" width="700"/>
...
<img src="./imgs/end44_1.png" width="700"/>
...
<img src="./imgs/end44_2.png" width="700"/>
...
<img src="./imgs/end45_1.png" width="700"/>
...
<br/>
<img src="./imgs/end45_2.png" width="700"/>
<img src="./imgs/end45_3.png" width="700"/>
...
<img src="./imgs/end45_4.png" width="700"/>
...
<img src="./imgs/end48.png" width="700"/>



<h3> 49강 (로그인 기능 구현) </h3>

<img src="./imgs/end49.png" width="700"/>
...
<img src="./imgs/end50_1.png" width="700"/>
...
<img src="./imgs/end50_2.png" width="700"/>

	===> Network패널로 이통해서 login을 눌러보면, 동일한 url로 요청을 했지만 권한이 없다는 의미의 401이 떠있다.
	===> 옆의 Preview를 살펴보자.
<br/>

<img src="./imgs/end50_3.png" width="700"/>
...
<img src="./imgs/end51_1.png" width="700"/>

	===> try{ } 속에 기존의 로그인성공 로직을 넣어준다. 
	===> catch( ) { } 에는 로그인실패시 에러를 확인할 수 있도록 콘솔로 찍어준다.
<br/>

<img src="./imgs/end51_2.png" width="700"/>
...
<img src="./imgs/end51_3.png" width="700"/>
...
<img src="./imgs/end51_4.png" width="700"/>
...
<img src="./imgs/end52_3.png" width="700"/>
...
<img src="./imgs/end53_1.png" width="700"/>
<img src="./imgs/end53_2.png" width="700"/>
...
<img src="./imgs/end54_1.png" width="700"/>
<img src="./imgs/end54_2.png" width="700"/>

	===> 유효한 id를 입력했을 때, vue의 LoginForm의 isFormValid가 true임을 볼 수 있다.	
<br/>

<img src="./imgs/end54_3.png" width="700"/>

	===> 유효하지 않은 id를 입력했을 때, vue의 LoginForm의 isFormValid가 false임을 볼 수 있다.
<br/>

<img src="./imgs/end54_4.png" width="700"/>
...
<img src="./imgs/end56_1.png" width="700"/>

	===> validation.js의 정규표현식에서 오류가 발생하는 것.
<br/>

<img src="./imgs/end56_2.png" width="700"/>
...
<img src="./imgs/end59.png" width="700"/>
...
<img src="./imgs/end60_1.png" width="700"/>
...
<img src="./imgs/end61.png" width="700"/>
...
<img src="./imgs/end62_1.png" width="700"/>
...
<img src="./imgs/end62_2.png" width="700"/>
...
<img src="./imgs/end62_3.png" width="700"/>
...
<img src="./imgs/end62_4.png" width="700"/>
...
<img src="./imgs/end63_1.png" width="700"/>
...
<img src="./imgs/end64_1.png" width="700"/>
...
<img src="./imgs/end64_2.png" width="700"/>
...
<img src="./imgs/end64_3.png" width="700"/>
...
<img src="./imgs/end64_4.png" width="700"/>
...
<img src="./imgs/end65_1.png" width="700"/>
...
<img src="./imgs/end65_2.png" width="700"/>

<br/>


<img src="./imgs/end65_3.png" width="700"/>
...
<img src="./imgs/end65_4.png" width="700"/>
...
<img src="./imgs/end67_1.png" width="700"/>
...
<img src="./imgs/end69_1.png" width="700"/>
...
<img src="./imgs/end69_2.png" width="700"/>
...
<img src="./imgs/end70_1.png" width="700"/>
...
<img src="./imgs/end71.png" width="700"/>
...
<img src="./imgs/end74_1.png" width="700"/>
...
<img src="./imgs/end74_2.png" width="700"/>
...
<img src="./imgs/end74_3.png" width="700"/>
...
<img src="./imgs/end74_4.png" width="700"/>
...
<img src="./imgs/end74_5.png" width="700"/>
...
<img src="./imgs/end76_1.png" width="700"/>

	===> api(index.js)에서 학습노트 데이터 조회용 api작성 후 export해줌.
<br/>

<img src="./imgs/end76_2.png" width="700"/>
...
<img src="./imgs/end77.png" width="700"/>
...
<img src="./imgs/end79_1.png" width="700"/>
...
<img src="./imgs/end80_1.png" width="700"/>
...
<img src="./imgs/end80_2.png" width="700"/>
	...
	===> props는 :postItem=“postItem”로 작성한다. 
		...
		- item이라는 props를 <PostListItem>의 컴포넌트(= PostListItem.vue)에서 받으면 된다.

<br/>

<img src="./imgs/end80_3.png" width="700"/>
...
<img src="./imgs/end82.png" width="700"/>
...
<img src="./imgs/end84.png" width="700"/>
...
<img src="./imgs/end85_1.png" width="700"/>

	===> utils폴더의 cookies.js파일 속 함수들을 이용할 것이다.
<br/>

<img src="./imgs/end85_2.png" width="700"/>

	===> cookied의 함수를 import해준다.
	===> { }를 이용해서 cookies파일 속의 함수를 바로 불러온 것.
<br/>

<img src="./imgs/end85_3.png" width="700"/>
...
<img src="./imgs/end85_4.png" width="700"/>
...
<img src="./imgs/end86_1.png" width="700"/>
...
<img src="./imgs/end86_2.png" width="700"/>
...
<img src="./imgs/end87_1.png" width="700"/>
...
<img src="./imgs/end87_2.png" width="700"/>
...
<img src="./imgs/end87_3.png" width="700"/>
